  ...
  build: {
    rollupOptions: {
      input: {
        ...
        "new-home-electrical-surrey": resolve(__dirname, 'new-home-electrical-surrey.html'),
        "landscape-lighting-surrey": resolve(__dirname, 'landscape-lighting-surrey.html'),
        "smart-home-automation-surrey": resolve(__dirname, 'smart-home-automation-surrey.html'),
      },
    },
  },
})
